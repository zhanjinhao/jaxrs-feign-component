...
public class SimpleJAXRSContract extends DeclarativeContract {
  ...
  public SimpleJAXRSContract(StringValueResolver stringValueResolver) {
  ...
  private String resolve(String str) {
    ...
    try {
      ...
      str = dollarHelper.replacePlaceholders(str, new PropertyPlaceholderHelper.PlaceholderResolver() {
        @Override
