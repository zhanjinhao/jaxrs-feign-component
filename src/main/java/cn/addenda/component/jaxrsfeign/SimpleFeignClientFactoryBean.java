 ...
 */
class SimpleFeignClientFactoryBean implements FactoryBean<Object>, InitializingBean, BeanFactoryAware, EmbeddedValueResolverAware {
  ...
  protected Builder feign() {
    ...
    Builder builder = Feign.builder()
            ...
            .client(client)
            .contract(new SimpleJAXRSContract(stringValueResolver))
